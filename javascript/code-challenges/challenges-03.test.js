...
const typeNum = (arr) => {
  // Solution code here...
 return (arr.filter((e=>{if(e/1===e){return true}})))
...
const containsAnd = (arr) => {
  // Solution code here...
  return(arr.filter((e)=>{if(e.includes("and")){return true}}))
};
...
const oddValues = (arr) => {
  // Solution code here...
  return(arr.filter((e)=>{if(e%2===1){return true}}))
};
...
return(
  arr.filter(e=>{
    if(forbiddenValues.includes(e)!==arr.includes(e)){return true}
  })
  )
};
